...
const appState = {
  ...
  globalCaptureValue: "",         // Global capture input (UI-only)
  ...
  settings: {
    ...
    shutdownTime: '22:30'        // 저녁 종료 루틴 권장 시각
  },
  templates: [],                    // 작업 템플릿 목록
  ...
  completionLog: {},
  loopStats: {},                     // Daily loop stats by logical date
  dailyLoop: {
    tomorrowTop3: [],
    shutdownNotes: {},
    lastMorningOpenDate: null,
    lastShutdownDate: null,
    shutdownDraft: ""
  },
  pendingEventStatusSync: [],        // Offline Supabase status PATCH queue
