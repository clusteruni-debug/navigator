...
const _navFunctions = {
  ...
  // 백업/데이터
  exportData, importData, exportArchivedData, exportToAssetManager,
  // 유틸
  getRepeatLabel, formatTime,
...
const tourSteps = [
  ...
  { selector: '.tab-nav', title: '📋 탭 네비게이션', desc: '오늘/본업/이벤트/일상 탭으로 전환. 더보기에서 통근/히스토리/자문도 볼 수 있습니다.' },
