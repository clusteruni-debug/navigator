...
function renderReflectionTab() {
  ...
  const dailyLoopHtml = (typeof renderDailyShutdownPanel === "function" ? renderDailyShutdownPanel() : "") + (typeof renderLoopGatePanel === "function" ? renderLoopGatePanel() : "") + (typeof renderStartTriggerGuide === "function" ? renderStartTriggerGuide() : "");
  ...
  const hydratedHtml = dailyLoopHtml + html;
  const container = document.getElementById('tab-content-reflection');
  if (container) container.innerHTML = hydratedHtml;
  return hydratedHtml;
}
