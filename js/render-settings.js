            ...
            <div class="modal-body">
              ...
              <div class="settings-section">
                ...
                <div class="settings-row" style="justify-content: center; margin-top: 8px;">
                  <button class="backup-btn" onclick="exportToAssetManager()" style="width: 100%; background: var(--bg-secondary); border-color: var(--border-color);" aria-label="자산관리 앱용 수익 데이터 내보내기">
                    💰 자산관리 내보내기
                  </button>
                </div>
