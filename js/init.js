...
renderStatic();
if (typeof installDailyLoopKeyboard === "function") installDailyLoopKeyboard();
if (navigator.onLine && typeof flushPendingEventStatusSync === "function") setTimeout(flushPendingEventStatusSync, 1000);
...
async function updateLinkedEventStatus(task, participated) {
  ...
  if (typeof syncLinkedEventStatus === "function") {
    await syncLinkedEventStatus(task, participated);
    return;
  }
