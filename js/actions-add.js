// ============================================
// 작업 추가 (Quick Add, Brain Dump, Detailed Add)
// (actions.js에서 분리)
// ============================================
...
function quickAddWorkTask() {
  ...
  // work-quick-input(일반업무 탭) / work-quick-input-all(전체 탭) 은 일반 본업 작업 전용 input.
  // 프로젝트 task 추가는 quickAddWorkProjectTask(work-project-quick-<id>)가 별도 담당한다.
  // (구버전: workView==='detail' 면 active 프로젝트로 라우팅했으나, redesign에선 프로젝트 상세를
  //  한 번 본 뒤 workView가 'detail'로 남아 — setWorkSubTab이 초기화 안 함 — 일반업무가 숨은
  //  프로젝트로 새고 일반 목록엔 안 뜨던 버그가 있어 라우팅 분기 제거. 2026-06-23)
...
function quickAdd() {
  ...
  if (typeof recordLoopCapture === "function") recordLoopCapture();
